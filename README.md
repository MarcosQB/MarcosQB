...
[Extração, Transformação e carregamento dos dados do Google Analytics utilizando Python](https://link-url-here.org](https://github.com/MarcosQB/ETL-with-GoogleAnalyticsAPI/blob/main/README.md))
